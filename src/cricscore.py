#!/usr/bin/env python
'''
Displays the score to console according to the arguments passed by the user.
'''
...
def liveCommentry(matchURL):
	...
	try:
		...
		sys.stderr.write("Couldn't open "+matchURL)
		return
	text = r.text
	soup = bs4.BeautifulSoup(text, "html.parser")
	matchtitle = soup.find("title").text
...
def startListner(gameList, gameIndex):
	...
	inactivityCount = 0
	liveCommentry(matchUrl+".html")
	rt = timer.RepeatTimer(30, liveCommentry, matchUrl)
